...
module pipeline_v(
    ...
    input wire [1:0] dummy_read_rf, output wire [7:0] dummy_rf_data  // just for reading regfile from the top level
);
...
wire [7:0] rs1_val = (rs1 == 2'd3) ? registers3 :
                     (rs1 == 2'd2) ? registers2 : 
                     (rs1 == 2'd1) ? registers1 : registers0 ;

wire [7:0] rs2_val = (rs2 == 2'd3) ? registers3 :
                     (rs2 == 2'd2) ? registers2 : 
                     (rs2 == 2'd1) ? registers1 : registers0 ;
...
always @(posedge clk ) begin
   if (wb_go && ex_wb_reg_wen && ex_wb_rd == 0) begin
     registers0 <= ex_wb_val;
   end
   if (wb_go && ex_wb_reg_wen && ex_wb_rd == 1) begin
     registers1 <= ex_wb_val;
   end
   if (wb_go && ex_wb_reg_wen && ex_wb_rd == 2) begin
     registers2 <= ex_wb_val;
   end
   if (wb_go && ex_wb_reg_wen && ex_wb_rd == 3) begin
     registers3 <= ex_wb_val;
   end
end

// dummy read
assign dummy_rf_data = (dummy_read_rf == 2'd3) ? registers3 :
                       (dummy_read_rf == 2'd2) ? registers2 : 
                       (dummy_read_rf == 2'd1) ? registers1 : registers0 ;


// These are environmental invariants
// It turns out this is not needed 
/*
assume property (scoreboard[0][1] == ( id_ex_valid && id_ex_reg_wen && id_ex_rd == 2'd0));
assume property (scoreboard[0][0] == ( ex_wb_valid && ex_wb_reg_wen && ex_wb_rd == 2'd0));
assume property (scoreboard[1][1] == ( id_ex_valid && id_ex_reg_wen && id_ex_rd == 2'd1));
assume property (scoreboard[1][0] == ( ex_wb_valid && ex_wb_reg_wen && ex_wb_rd == 2'd1));
assume property (scoreboard[2][1] == ( id_ex_valid && id_ex_reg_wen && id_ex_rd == 2'd2));
assume property (scoreboard[2][0] == ( ex_wb_valid && ex_wb_reg_wen && ex_wb_rd == 2'd2));
assume property (scoreboard[3][1] == ( id_ex_valid && id_ex_reg_wen && id_ex_rd == 2'd3));
assume property (scoreboard[3][0] == ( ex_wb_valid && ex_wb_reg_wen && ex_wb_rd == 2'd3));
*/

// ---------------------------------------------------

/* below are the final conditions to prove
// this one is easily proven by model checking
// You can uncomment and check it in JG

wire [7:0] e1 = ex_alu_result; // input !!! // register
wire [1:0] e2 = rs1;
wire e3 = e2 == 2'b11;
wire e4 = e2 == 2'b10;
wire e5 = e2 == 2'b01;
wire [1:0] e6 = inst[3:2];
wire e7 = rs2 == 3;
wire e8 = rs2 == 2;
wire e9 = rs2 == 1;
...
wire [7:0] e13 = id_ex_valid ? e1 : ex_wb_val;
wire [1:0] e14 = id_ex_valid ? id_ex_rd : ex_wb_rd;
wire e15 = id_ex_valid & id_ex_reg_wen;
wire [7:0] e16 =  ((e14 == 2'b00) && e15) ? e13 : ( ( (ex_wb_rd == 2'b00)  && e10) ? ex_wb_val : registers0);
wire [7:0] e17 = ((e14 == 2'b01) && e15) ? e13 : ( ( (ex_wb_rd == 2'b01)  && e10) ? ex_wb_val : registers1);
wire [7:0] e18 = ((e14 == 2'b10) && e15) ? e13 : ( ( (ex_wb_rd == 2'b10)  && e10) ? ex_wb_val : registers2);
wire [7:0] e19 = ((e14 == 2'b11) && e15) ? e13 : ( ( (ex_wb_rd == 2'b11)  && e10) ? ex_wb_val : registers3);
wire [7:0] ite1 = (inst[7:6] == 2'b10) ? {4'b0000,inst[5:2]} : (
 e11 == 2'b00 ? ( e3 ? registers3 : e4 ? registers2 : e5 ? registers1 : registers0 ) : ( e11 == 2'b01 ? ex_wb_val : e1 ) );

wire [7:0] ite2 = (e12 == 2'b00) ? ( e7 ? registers3 : e8 ? registers2 : e9 ? registers1 : registers0 ) : (e12 == 2'b01 ? ex_wb_val : e1);

wire [7:0] ite3 = e3 ? e19 : e4 ? e18 : e5 ? e17 : e16;
wire [7:0] ite4 = e7 ? e19 : e8 ? e18 : e9 ? e17 : e16;

wire finalcond = ((ite1 + ite2) == (ite3 + ite4));
wire decode = (inst_valid && inst_ready && op == `OP_ADD);
